                ...
                if(discr>=0):
                    ...
                    if t!=-1 and (s+t)%2==0:
                        ...
                        if len(roots) == 2:
                            ...
                            print(self.p)
                            print(self.q)
                            print(self.p * self.q - n)
                        break

e = 672865082552982655192224709618398989937402830127134923949297221992987771706470487153478669033245757920424105998433548641764220134156329348553326683709
d = 7024562305246701265570086527473841161333
